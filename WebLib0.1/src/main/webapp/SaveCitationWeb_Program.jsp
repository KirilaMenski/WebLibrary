...
<body>
	...
	<div class="mainblock">
		...
		<div id="windowhead">
			<ul>
				<li><a href="savecitation.by"><spring:message
							code="page.main" /></a>
					<ul>
		<!-- Выправіць -->				<li><a href="SaveCitationWeb.jsp" title="Project"><spring:message
									code="label.aboutProj" /></a></li>
		<!-- Выправіць -->				<li><a href="SaveCitationWeb.jsp"
							title="Author"><spring:message
				...
				<li><a href="savecitation_programs.by"><spring:message
							code="page.prog" /></a>
					<ul>
		<!-- Выправіць -->				<li><a href="SaveCitationWeb_Program_PC.jsp" title="Для ПК"><spring:message
									code="label.PC" /></a></li>
		<!-- Выправіць -->			<li><a href="SaveCitationWeb_Program_Mobile.jsp"
		...
		<div id="window">
			<div id="text">
				<ul>
					<li><a href="SaveCitationWeb_Program_PC.jsp">Праграмы для
							кампутара</a></li>
					<li><a href="SaveCitationWeb_Program_Mobile.jsp">Праграмы
