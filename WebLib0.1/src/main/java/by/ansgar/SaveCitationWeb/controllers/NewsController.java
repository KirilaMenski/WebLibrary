...
import by.ansgar.SaveCitationWeb.service.LinkNewsComService;
import by.ansgar.SaveCitationWeb.service.NewsCommentsService;
...
public class NewsController {
	...
	public String newsViewPage(@PathVariable long id, Model model) {
		...
		try {
			...
			newsId = id;
			List<LinkNewsCom> resultNewsCom = linkNewsComService
					.getAllComent(id);
			System.out.println(resultNewsCom);
			model.addAttribute("linkNewsCom", resultNewsCom);
